...
This part outlines the standard architecture for combining **PyTorch Lightning** (for boilerplate-free training) and **Optuna** (for automated hyperparameter tuning). 

This template uses internal scaling (`nn.BatchNorm1d`) and tracks validation loss to find the perfect learning rate and layer sizes.
